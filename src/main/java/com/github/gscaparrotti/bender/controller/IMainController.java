...
public interface IMainController {
     ...
     * @param viewCtrl
     *            Your {@link IMainViewController}, which controls the application.view.
     * @param dialogCtrl
     *            Your {@link IDialogController}, which will control the
     *            {@link ITableDialog} instances.
     * 
     *            Sets the main application.view and the related controllers.
     */
    ...
    /**
     * Sets the {@link NetworkController} , which will be
     ...
     * 
     *            Shows a generic message on the main application.view. You can use this
     ...
     * 
     *            Shows a severe error on the main application.view.
     */
